...
orderForm.addEventListener("change", function () {
  for (var i = 0; i < orderForm.elements.productContent.length; i++) {
  ...
  for (var _i = 0; _i < orderForm.elements.productSize.length; _i++) {
    if (orderForm.elements.productSize[_i].checked === true) {
      orderForm.elements.sizeOutput.value = orderForm.elements.productSize[_i].value;
      return;
    }
  }

  for (var _i2 = 0; _i2 < orderForm.elements.productAppearance.length; _i2++) {
    if (orderForm.elements.productAppearance[_i2].checked === true) {
      orderForm.elements.appearanceOutput.value = orderForm.elements.productAppearance[_i2].value;
      return;
    }
  }
});
...
var sliderControl = function sliderControl(slider) {
  ...
  var toggleSlide = function toggleSlide(slide) {
  ...
  var swipeControl = function swipeControl(control) {
